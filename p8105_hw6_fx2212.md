...
The 95% confidence interval for R² is (0.935, 0.947) and for β₁/β₂ is
(-277.485, -124.4).
...
320.3, model 1 (using only birth length and gestational age) has an RMSE
of 332.9, and model 2 (using head circumference, length, sex, and all
interactions) has an RMSE of 289.3. The proposed model performs better
